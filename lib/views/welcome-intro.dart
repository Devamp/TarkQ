                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          welcomeModule(
                            Icons.add,
                            "Get started by clicking the + button on the Looking for Raid (LFR) page to create your first raid ticket.",
                            context,
                          ),
                          welcomeModule(
                            Icons.public,
                            "Visit the LFR page to view active raid tickets from other users to find your next squad!",
                            context,
                          ),
                          welcomeModule(
                            Icons.person,
                          ...
                          welcomeModule(
                            ...
                            "This app is in beta, new updates/patches releasing regularly.",
                            context,
                          ),
                        ],
                      ),
